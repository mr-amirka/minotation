...
describe('mn — keyframes и произвольный CSS', () => {
  ...
  // Тест на mn.css() убран вместе с самим методом 2026-09-23 (владелец: убрать
...
describe('mn — strict', () => {
  ...
  test('strict: true — чужие CSS-классы сборку НЕ роняют (Q-12)', () => {
...
/**
 * Q-06 (решение владельца 2026-09-24): битый аргумент хендлера — ошибка автора
