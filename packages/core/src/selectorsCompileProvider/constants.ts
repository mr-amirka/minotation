 ...
 * предупреждения — молчаливый мусор в CSS недопустим. При этом форма со знаком `-` (`w10---a`)
 ...
 *
 * Последнее — по той же логике, что исключение для точки, и оставлено на
 * будущее: **сторонний пресет может завести хендлер, где `#hex` в значении
 * осмыслен**, и парсер не должен ему мешать.
