...
function iterateeCheckImportant(
  a, v, k,
) {
...
function minimalistNotationProvider(options) {
  ...
  function baseSetEssenseBase(
    ...
    baseSet(
      $$staticsEssences, path, __mergeDepth([baseGet($$staticsEssences, path), __normalize(extendedEssence)], {}),
    );
  }
...
export default minimalistNotationProvider;
export {
